...
# produced the tool schemas. Run this deliberately, then commit the spec change
# alongside the regenerated src/schema.gen.ts, so a reviewer sees both.
#
...
SPEC_URL="${SPEC_URL:-https://s3.internetdata.io/internetdata-public/openapi/openapi.json}"
